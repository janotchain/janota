...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 7762959=Janeta, 7762955=Musictest)",
...
// for JANETAD and returns half of the allowance to assign to the database.
...
// new format.
//
// e.g. janetad account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// janetad --keystore /tmp/mykeystore --lightkdf account new
//
