...
// Welcome show summary of current JANETAD instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic JANETAD metadata
	fmt.Fprintf(c.printer, "Welcome to the JANETAD JavaScript console!\n\n")
	c.jsre.Run(`
