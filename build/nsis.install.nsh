Name "janetad ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/janotchain/go-janetacoin/issues"
!define UPDATEURL "https://github.com/janotchain/go-janetacoin/releases"
!define ABOUTURL "https://github.com/janotchain/go-janetacoin"
...
# Install janetad binary
Section "JANETAD" JANETAD_IDX
  SetOutPath $INSTDIR
  file {{.JANETAD}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\janetad.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\janetad.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "JANETAD incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "JANETAD outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "JANETAD UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "JANETAD incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\janetad.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "JANETAD outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\janetad.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "JANETAD UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\janetad.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\janetad.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\janetad.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${JANETAD_IDX}
    SectionGetSize ${JANETAD_IDX} $0
