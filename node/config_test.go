...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "janetad.ipc", false, filepath.Join(os.TempDir(), "janetad.ipc")},
		{"data", "janetad.ipc", false, "data/janetad.ipc"},
		{"data", "./janetad.ipc", false, "./janetad.ipc"},
		{"data", "/janetad.ipc", false, "/janetad.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "janetad.ipc", true, `\\.\pipe\janetad.ipc`},
		{"data", "janetad.ipc", true, `\\.\pipe\janetad.ipc`},
		{"data", `\\.\pipe\janetad.ipc`, true, `\\.\pipe\janetad.ipc`},
	}
